...
func Compare(gameBoard map[int]*Tile, luckySlot *[]string, symbol string) {
	...
	if !isEreased {
		...
		// 執行移除 luckySlot 需要砍掉的符號
		// fmt.Println("!!!!!indexNeedToCut", indexNeedToCut)
		// fmt.Println("!!!!!luckySlot", luckySlot)
	...
	// fmt.Printf("compre finish, isEreased: %+v\n", isEreased)
